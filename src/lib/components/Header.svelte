<script>
	import furniture from '$lib/assets/furniture.jpeg';
</script>

<div
	class="
    flex items-center justify-around w-full h-screen
     bg-[url('$lib/assets/furniture4.webp')] bg-no-repeat bg-center bg-cover"
>
	<!-- box -->
	<div
		class="w-4/5 p-10 space-y-8 rounded-md 2xl:w-fit xl:w-fit lg:w-fit md:w-fit variant-glass-surface"
	>
		<!--  Title -->
		<div class="flex flex-col items-start justify-center space-y-2">
			<p class="text-4xl font-thin 2xl:text-5xl xl:text-5xl lg:text-5xl md:text-5xl">
				Make Your Place A
			</p>
			<p class="text-4xl font-semibold">Better Living</p>
		</div>
		<!-- info -->
		<p class="font-thin">
			Urban crafty furniture with modern , simple and elegant design for your home
		</p>
		<!-- button -->
		<button
			class="px-16 py-3 text-sm font-semibold border-2 border-transparent rounded-md bg-surface-600 hover:bg-white hover:border-2 hover:border-surface-600 hover:text-surface-600"
		>
			Buy Now
		</button>
	</div>
